...
CREATE TABLE IF NOT EXISTS clo_analyses (
  ...
  switch_currency TEXT,
  switch_currency_raw TEXT,
  switch_currency_canonical TEXT,
  switch_currency_source TEXT,
...
CREATE TABLE IF NOT EXISTS clo_deals (
  ...
  jurisdiction TEXT,
  deal_currency TEXT,
  deal_currency_raw TEXT,
  deal_currency_canonical TEXT,
  deal_currency_source TEXT,
  closing_date TEXT,
  effective_date TEXT,
...
CREATE TABLE IF NOT EXISTS clo_tranches (
  ...
  payment_frequency_raw TEXT,
  payment_frequency_canonical TEXT,
  payment_frequency_source TEXT,
...
CREATE TABLE IF NOT EXISTS clo_holdings (
  ...
  currency_canonical TEXT,
  currency_source TEXT,
  native_currency_raw TEXT,
  native_currency_canonical TEXT,
  country TEXT,
  industry_code TEXT,
